...
This directory has been vedored off of <https://github.com/jupyterhub/jupyterhub-deploy-docker>.
If you wish to create your own JupyterHub that is not connected to ScriptedForms please use that repository instead.
Changes have been made with the intent to work with ScriptedForms on an internal network.
Please note that by default the SSL features of the original repo have been removed.
