...
Furthermore do not run a scripted form unless you trust its origin. Give the reactive nature of ScriptedForms code within the markdown template can run on form opening, as well as during usage.
